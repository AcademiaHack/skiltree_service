...
<body class="tree_background">
	...
	<header class="navbar navbar-fixed-top tree_nav" role="banner">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="http://plataforma.hack4geeks.co/category/news/">
					<img class="logo_hack" src="http://plataforma.hack4geeks.co/wp-content/themes/HackRoots/assets/img/logo.png" alt="">
				</a>
			</div>
		</div>
	</header>
			...
			<div class="blue-sidebar">
				<div class="row">
					<div class="col-sm-12">
						<br>
						<div class="user-info">
							<h3 class="user-name-info">
								Perfil del estudiante
							</h3>
							<hr>
							<h4 class="user-name-info">
								Asistencia: <span id="attendance_number" class="pull-right">.</span>
							</h4>
							<h4 class="user-email-info">
								Tareas Entregadas: <span id="homeworks_number" class="pull-right">.</span>
							</h4>
						</div>
					</div>
				</div>
